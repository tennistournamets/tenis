export const draftMessages = {
  ru: {
    ...
    leaveSaving: 'Сохранение ещё выполняется. Уйти со страницы, не дожидаясь ответа сервера?',
    leaveAnyway: 'Уйти',
  ...
  en: {
    ...
    leaveSaving: 'Saving is still in progress. Leave the page without waiting for the server?',
    leaveAnyway: 'Leave',
